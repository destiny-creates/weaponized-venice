...
==================================================================================\n''')
    ...
    try:
        client = OpenAI(api_key=key, base_url='https://api.venice.ai/api/v1')

        response = client.chat.completions.create(model='venice-uncensored', messages=[{'role': 'system',
        ...
        print(
            '[+] Scanning done, you can find the output in the files in this directory. If you prefer to have the results output to your terminal, remove the capture_output=true and text=True args in the source ya skid ;)')
